...
public:
    ...
    {
                _L[0][0]=-xi_[0]/_P.get_Z();
                _L[0][1]=0;
                _L[0][2]=xi_[0]*_P.get_x()/_P.get_Z();
                _L[0][3]=xi_[0]*_P.get_x()*_P.get_y();
                _L[0][4]=-xi_[0]*(1+_P.get_x()*_P.get_x());
                _L[0][5]=xi_[0]*_P.get_y();
                _L[1][0]=0;
                _L[1][1]=-xi_[1]/_P.get_Z();
                _L[1][2]=xi_[1]*_P.get_y()/_P.get_Z();
                _L[1][3]=xi_[1]*(1+_P.get_y()*_P.get_y());
                _L[1][4]=-xi_[1]*_P.get_x()*_P.get_y();
                _L[1][5]=-xi_[1]*_P.get_x();
